...
const ChatPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row bg-[#F0F7F7] px-4 pt-4 gap-4">
        {/* Left Sidebar */}
        ...
        <div className="flex-1 flex flex-col bg-white mb-4 rounded-2xl overflow-hidden">
          ...
          {/* Chat Messages */}
          <div className="flex-1  p-4 space-y-4 xl:max-h-[calc(100vh_-_270px)] md:max-h-[calc(100vh_-_278px)] overflow-y-auto scrollbar-hidden">
          ...
          {/* Input Box */}
          <div className="p-2 flex items-center bg-white space-x-2">
            {/* Profile Image */}
            <img
              src={profilePhoto}
              alt="Profile"
